...
<div >
    <nav class="navbar navbar-expand navbar-light bg-white mb-4" >
        ...
        <!-- Topbar Navbar -->
        <ul class="navbar-nav ms-auto justify-content-end flex-row">
          ...
          <li class="nav-item dropdown">
            @auth
            <li class="nav-item dropdown">
                <a id="navbarDropdown" class="nav-link dropdown-toggle fw-medium text-muted" href="#"
...
<footer>
    <div class="footer clearfix text-muted fixed-bottom">
